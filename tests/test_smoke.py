"""
kerdostat/tests/test_smoke.py

Connectivity smoke test for the Alpaca broker integration.

Two modes:
  1. Real credentials present → hits paper-trading API, asserts account fields.
  2. No credentials → asserts the endpoint returns HTTP 503 gracefully.
...
class TestBrokerSmokeTest:
    ...
    def test_broker_health_no_credentials(self, monkeypatch):
        """
    ...
    def test_broker_health_live(self):
        """
